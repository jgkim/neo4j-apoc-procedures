...
| apoc.index.addNodeByName('name',node,['prop1',...]) | add node to an index for the given index name
| apoc.index.addRelationship(rel,['prop1',...]) | add relationship to an index for its type
| apoc.index.addRelationshipByName('name',rel,['prop1',...]) | add relationship to an index for the given index name
|===
